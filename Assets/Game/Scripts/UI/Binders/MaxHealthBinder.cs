...
namespace Asteroids
{
    public class MaxHealthBinder : IBinder, IObserver<int>
    {
        private readonly ReactiveProperty<int> _viewProperty;
        private readonly IReadOnlyReactiveProperty<int> _modelProperty;
        private IDisposable _handle;

        public MaxHealthBinder(ReactiveProperty<int> view, IReadOnlyReactiveProperty<int> property)
        {
            _viewProperty = view;
        ...
        public void OnNext(int value) => _viewProperty.Value = value;
